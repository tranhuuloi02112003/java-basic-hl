...
public class StudentScoreManager {
    ...
    public static Student findTopStudentInSubject(String subjectName, List<Student> students) {
    ...
    public static ArrayList<Student> sortStudentByGPA(List<Student> students) {
    ...
    public static void main(String[] args) {
        ...
        for (Student student : listStudent) {
            student.displayInfo();
            System.out.println(", GPA: " + (double) calculateGPA(student));
        }
        ...
        ArrayList<Student> sorted = sortStudentByGPA(listStudent);
        for (Student student : sorted) {
            student.displayInfo();
            System.out.print(", GPA: " + (double) calculateGPA(student) + "\n");
        }
    }
}
